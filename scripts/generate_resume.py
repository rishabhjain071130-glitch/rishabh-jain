...
def generate_docx(output_path):
    ...
    summary_p = doc.add_paragraph(
        "Computer Science Student specializing in Full Stack Development, Artificial Intelligence, and Cyber Security. "
        "Proven track record of engineering secure, intelligent, and scalable software through hands-on, real-world projects. "
        "Equipped with strong analytical problem-solving skills and industry-standard technical certifications."
    )
    ...
    p_gla.add_run(", Diploma in Computer Science and Engineering (Lateral Entry)")
    ...
    p = doc.add_paragraph(
        "Designed terminal-themed developer portfolio featuring CLI console simulation and rate-limited forms.",
        style='List Bullet'
    )
    p.paragraph_format.space_after = Pt(1)
    p.paragraph_format.left_indent = Inches(0.2)
    ...
    p = doc.add_paragraph(
        "Built AI career mentor mapping skill gaps and generating custom roadmaps using Gemini API prompts.",
        style='List Bullet'
    )
    p.paragraph_format.space_after = Pt(1)
    p.paragraph_format.left_indent = Inches(0.2)
    ...
    certs = [
        "**Oracle Database SQL Certified Associate** – SQL queries, database indexing, and relational models (Dec 2025)",
        "**Microsoft Agentic AI Certification** – Development and deployment of autonomous LLM agent systems (June 2026)",
        "**Microsoft Web Technology Specialization** – Standard-compliant frontend and backend implementations (June 2026)",
        "**Palo Alto Networks Network Security Gateway** – Network defense and firewall rule configurations (June 2026)",
        "**IBM Machine Learning Roadmap Certification** – Core ML models, pipelines, and data architectures (Jan 2026)",
        "**Google Generative AI Course Completion** – Prompt engineering, LLM tuning, and AI safety practices (May 2026)",
        "**Internshala Cyber Security with AI Training** – Threat detection and AI-assisted security response (Jan 2026)"
    ]
    for c in certs:
...
def generate_pdf(output_path):
    ...
    def add_section_header(title_text):
        ...
        story.append(HRFlowable(width="100%", thickness=0.8, color=rule_grey, spaceBefore=0.5, spaceAfter=2.5))
    ...
    edu_data = [
        [
            Paragraph("<b>GLA University</b>, Diploma in Computer Science and Engineering (Lateral Entry)", body_style),
            Paragraph("Expected 2027", ParagraphStyle('RightText', parent=body_style, alignment=TA_RIGHT))
        ],
        [
    ...
    add_section_header("Certifications")
    certs = [
        "<b>Oracle Database SQL Certified Associate</b> – SQL queries, database indexing, and relational models (Dec 2025)",
        "<b>Microsoft Agentic AI Certification</b> – Development and deployment of autonomous LLM agent systems (June 2026)",
        "<b>Microsoft Web Technology Specialization</b> – Standard-compliant frontend and backend implementations (June 2026)",
        "<b>Palo Alto Networks Network Security Gateway</b> – Network defense and firewall rule configurations (June 2026)",
        "<b>IBM Machine Learning Roadmap Certification</b> – Core ML models, pipelines, and data architectures (Jan 2026)",
        "<b>Google Generative AI Course Completion</b> – Prompt engineering, LLM tuning, and AI safety practices (May 2026)",
        "<b>Internshala Cyber Security with AI Training</b> – Threat detection and AI-assisted security response (Jan 2026)"
    ]
    for c in certs:
